    ...
    if (isset($_POST['register'])) {
        ...
        if ($query->rowCount() == 0) {
            ...
            if ($result) {
                ...
                echo '<p class="success">Оплата прошла успешно!</p>';
            } else {
...
<form action='add_oplata.php' method='post' >
<div class="form-container">
  ...
  <div class="field-container">
    ...
    <input id="cardnumber" name='card_nomber' type="text" pattern="[0-9]*" inputmode="numeric">
  ...
  <div class="field-container">
    ...
    <input id="expirationdate" name='card_validity_date' type="text" pattern="[0-9]*" inputmode="numeric">
  </div>
  <div class="field-container">
    <label for="securitycode">Security Code</label>
    <input id="securitycode" name='security_code' type="text" pattern="[0-9]*" inputmode="numeric">
  </div>
    <div class="field-container">
    <label for="cardnumber">Donation amount</label></span>
    <input id="cardnumber" name='Donation_amount' type="text" pattern="[0-9]*" inputmode="numeric">
    <svg id="ccicon" class="ccicon" width="750" height="471" viewBox="0 0 750 471" version="1.1"
      xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink">
    </svg>
  </div>
  ...
  <br>
  <br>
  <button type="submit" > Подтвердить оплату
	</button>
</div>
          </FORM>
</body>
